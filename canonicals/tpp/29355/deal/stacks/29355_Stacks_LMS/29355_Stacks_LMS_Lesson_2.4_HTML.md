---
slug: 29355_Stacks_LMS_Lesson_2.4_HTML
body_type: stack-html
sd_item_id: 29355
platform: tpp
cu_page_id: 80djf-708617
cu_url: 'https://app.clickup.com/8402511/v/dc/80djf-83497/80djf-708617'
cu_parent_page_id: 80djf-708257
cu_path: >-
  Item 29355 - Tax Prep Setup > Deal > Item: 29355 - Stacks > 29355_Stacks_LMS >
  29355_Stacks_LMS_Lesson_2.4_HTML
last_synced: '2026-05-09'
last_editor: JLW
status: live
parent_stack_slug: 29355_Stacks_LMS
---
<div class="lms-lesson lms-lesson-2-4">

  <div class="lms-block lms-block-video">
    <div class="lms-video-wrap">
      <iframe
        src="https://www.youtube.com/embed/hrvhpjNsXyc"
        title="How to Customize Phase 1"
        frameborder="0"
  ...
  <div class="lms-block lms-block-text">
    <p>To customize Phase 1, edit any of these in your SuiteDash:</p>
  </div>

  <div class="lms-block lms-block-checklist">
    <ul>
      <li>Tax Prep Form 0 — Booking Form (form fields, Taxpayer Type options)</li>
      <li>Landing Page 1 — Book a Tax Appointment (headline, layout, branding)</li>
      <li>Email Template — Appointment Booked (To Target)</li>
      <li>Email Template — Appointment Booked (To Staff)</li>
      <li>Marketing Audience 1 — Lead / Re-Engagement Campaign</li>
    </ul>
  </div>
  ...
  <div class="lms-block lms-block-button lms-block-button-next">
    <a href="#lesson-3-1" class="lms-btn lms-btn-next" data-lesson-next="3.1">Continue to Lesson 3.1</a>
  </div>
