...
export const VACUOUS = [
  ...
  { id: 'G-262', file: 'sweep-boundary.mjs', anchor: "try { const d = JSON.parse(r(p)); return !!(d._generator || d.meta?.generator); } catch { return false; }", verdict: 'sound',
