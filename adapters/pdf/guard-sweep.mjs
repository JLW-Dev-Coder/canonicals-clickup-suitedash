...
export const VACUOUS = [
  ...
  { id: 'G-243', file: 'sweep-boundary.mjs', anchor: "try { const d = JSON.parse(r(`adapters/pdf/maps/${f}`)); gen = d._generator || d.meta?.generator || null; } catch { gen = null; }", verdict: 'sound',
